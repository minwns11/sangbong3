...
public class CategoryController {
    private static Logger logger = (Logger) LoggerFactory.getLogger(CategoryController.class);

    @Autowired
    private ICategoryService categoryService;

    @PostMapping
    public ResponseEntity<ICategory> insertCtg(@RequestBody CategoryDto dto) {
        try {
            if (dto == null) {
